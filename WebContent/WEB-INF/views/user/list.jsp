...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <a href="#" id="export-btn" class="easyui-linkbutton" iconCls="icon-arrow-down">导出Excel</a>
        </div>
    </div>
    <!-- End of toolbar -->
...
<script type="text/javascript">
	...
	*/
	...
	$("#export-btn").click(function(){
		...
		window.location.href =  'exportUserList?roleId='+roleId+'&sex='+sex+'&username='+username;
	});
