...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td width="60" align="right">菜名:</td>
                <td><input type="text" name="foodname" class="wu-text easyui-validatebox" /></td>
            </tr>
            <tr>
                <td width="60" align="right">价格:</td>
                <td><input type="text" name="price" class="wu-text easyui-validatebox" /></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">菜名:</td>
                <td><input type="text" id="edit-foodname" name="foodname" class="wu-text easyui-validatebox" /></td>
            </tr>
            <tr>
                <td width="60" align="right">价格:</td>
                <td><input type="text" id="edit-price" name="price" class="wu-text easyui-validatebox" /></td>
            </tr>
...
<script type="text/javascript">
	...
	*/
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-foodname").val(item.foodname);
	...
	$("#search-btn").click(function(){
		...
		var option = {foodname:$("#search-name").val()};
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'菜品实拍',width:100,align:'center',formatter:function(value,row,index){
				var img = '<img src="'+value+'" width="50px" />';
				return img;
			}},
			{ field:'foodname',title:'菜名',width:100,sortable:true},
			{ field:'price',title:'价格密码',width:100}
		]],
